...
import com.mpp.librarysys.LibrarysysApplication;
...
public class MppFxApplication extends Application {
    ...
    public void init() throws Exception {
        ApplicationContextInitializer<GenericApplicationContext> initializer = new ApplicationContextInitializer<GenericApplicationContext>() {
            ...
            public void initialize(GenericApplicationContext genericApplicationContext) {
                genericApplicationContext.registerBean(Application.class, () -> MppFxApplication.this);
        ...
        this.context = new SpringApplicationBuilder().sources(LibrarysysApplication.class)
